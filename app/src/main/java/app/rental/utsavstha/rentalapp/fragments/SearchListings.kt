...
class SearchListings : Fragment() {

    // TODO: Rename and change types of parameters
    private var mParam1: String? = null
    private var mParam2: String? = null
    private var listingsAdapter: ListingsAdapter? = null
    private var listingRecyclerView: RecyclerView? = null
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        val rootView = inflater!!.inflate(R.layout.fragment_search_listings, container, false)
    ...
    private fun init(rootView: View) {
        ...
        listingsAdapter = ListingsAdapter(object : CallBacks.ListingsAdapterCallBack {
